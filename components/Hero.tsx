        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6 lg:space-y-8">
            <div className="space-y-4">
              ...
              {/* Description - adjusted width and font size */}
              <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-[90%] sm:max-w-[85%] md:max-w-[600px] mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              <Button 
                size="lg" 
                className="w-full sm:w-auto bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 hover:from-purple-700 hover:via-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 animate-gradient bg-[length:200%_auto]"
              >
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="w-full sm:w-auto border-2 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200"
              >
          ...
          {/* Right side illustration - improved mobile scaling */}
          <div className="flex-1 relative w-full max-w-[300px] sm:max-w-[400px] lg:max-w-[600px] aspect-square mt-8 lg:mt-0">
